...
<<<<<<< Updated upstream
--Account Cliente
insert into utente(data_nascita,id,cognome,email,nome)VALUES( '2025-05-26', 2, 'cliente', 'cliente@gmail.com', 'cliente');
insert into credentials(cliente_id,dipendente_id,id,password_encode,ruolo,username) values(2,null,2,'$2a$10$j0D3ihWhsI/BTGzwI9k1tOyspT1ev4Ump.X.TQLA16lJl0cQm4VrW','CLIENTE','cliente');
=======